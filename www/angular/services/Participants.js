...
function Participants() {
	...
	//Bacon Change LxNotification to ionicPopUp
    this.showError = function ($window, $ionicPopup, e) {
    ...
    this.forceClose = function ($window, $ionicPopup, msg) {
        if (displayingRelogin) {
            console.warn('Already displaying an alert that leads to relogin');
            return false;
        }
    ...
    this.alertMediaError = function ($window, $ionicPopup, msg, callback) {
        if (displayingRelogin) {
            console.warn('Already displaying an alert that leads to relogin');
            return false;
        }
        var confirmPopup = $ionicPopup.confirm({
            title: 'Warning!',
            template: 'Server media error: ' + msg + ". Please reconnect."
        });
